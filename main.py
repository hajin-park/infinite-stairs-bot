...
images     = Images()
sct        = WindowCapture()
detector   = ObjectDetection(images.stair_images, sct.horizontal_layers, sct.vertical_layers)
...
def main():
    ...
    while sct.screenshot is None: sleep(0) #    wait for the first screenshot
    ...
    while True:
        ...
        #   update bot actions
        if (bot.state == 'READY'): bot.update_actions(pathfinder.actions)
